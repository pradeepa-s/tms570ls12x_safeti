...
#ifndef __SL_REG_CAN_H__
#define __SL_REG_CAN_H__
...
*   This type is used to access the CAN Registers.
*/
typedef volatile struct sl_canBase
{
    ...
    uint32		ECCDIAG_STAT;
    uint32		ECC_CS;
    uint32		ECC_SBEC;	  /**< 0x0030: ECC Single Bit Error Code Register	  */
...
*/
#define sl_canREG1 ((sl_canBASE_t *)0xFFF7DC00U)
...
*/
#define sl_canREG2 ((sl_canBASE_t *)0xFFF7DE00U)
...
*/
#define sl_canREG3 ((sl_canBASE_t *)0xFFF7E000U)
...
*/
#define sl_canREG4 ((sl_canBASE_t *)0xFFF7E200U)
...
*/
#define sl_canRAM1 (*(volatile uint32 *)0xFF1E0000U)
...
*/
#define sl_canRAM2 (*(volatile uint32 *)0xFF1C0000U)
...
*/
#define sl_canRAM3 (*(volatile uint32 *)0xFF1A0000U)
...
*/
#define sl_canRAM4 (*(volatile uint32 *)0xFF180000U)
...
*/
#define sl_canPARRAM1 (*(volatile uint32 *)(0xFF1E0000U + 0x10U))
...
*   for testing RAM parity error detect logic.
*/
#define sl_canPARRAM2 (*(volatile uint32 *)(0xFF1C0000U + 0x10U))
...
*   for testing RAM parity error detect logic.
*/
#define sl_canPARRAM3 (*(volatile uint32 *)(0xFF1A0000U + 0x10U))
...
*   for testing RAM parity error detect logic.
*/
#define sl_canPARRAM4 (*(volatile uint32 *)(0xFF180000U + 0x10U))
